...
export class PurchaseItemDto {
  ...
  @ApiProperty({
    example: 5.5,
    description: 'Unit cost price in purchase currency',
  })
  @IsNumber()
  @Min(0)
  cost: number;
...
export class CreatePurchaseDto {
  ...
  @ApiProperty({
    example: 36.5,
    required: false,
    description: 'Exchange rate at time of purchase',
  })
  @IsNumber()
  @IsOptional()
  exchangeRate?: number;
  ...
  @ApiProperty({
    example: 55.0,
    required: false,
    description: 'Initial amount paid',
  })
  @IsNumber()
  @IsOptional()
  @Min(0)
  ...
  @ApiProperty({
    example: 8.8,
    required: false,
    description: 'Total tax amount from invoice',
  })
  @IsNumber()
  @IsOptional()
  @Min(0)
  ...
  @ApiProperty({
    example: 63.8,
    required: false,
    description: 'Total amount of the purchase (subtotal + tax)',
  })
  @IsNumber()
  @IsOptional()
  @Min(0)
